...
namespace SilverstripeLtd\AiMetadata\Tests\Reports;
 ...
 */
class AiMetadataReportTest extends SapphireTest
{
    ...
    public function testReportStatusesAndFiltering(): void
    {
        ...
        $stale->write();
        $staleMeta = $stale->getOrCreateAiMetadata();
        ...
        $unreviewed->write();
        $unreviewedMeta = $unreviewed->getOrCreateAiMetadata();
        ...
        $ok->write();
        $okMeta = $ok->getOrCreateAiMetadata();
        ...
        $okPublished->write();
        $okPublishedMeta = $okPublished->getOrCreateAiMetadata();
        ...
        $unreviewedStaleMeta = $unreviewedStale->getOrCreateAiMetadata();
    ...
    public function testReportLiveStatusColumn(): void
    {
        ...
        $draftPage->write();
        $draftMeta = $draftPage->getOrCreateAiMetadata();
        ...
        $publishedPage->write();
        $publishedMeta = $publishedPage->getOrCreateAiMetadata();
        ...
        $outdatedPage->write();
        $outdatedMeta = $outdatedPage->getOrCreateAiMetadata();
