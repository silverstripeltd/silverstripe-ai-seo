...
/**
 * Centralises AI SEO state checks (staleness, draft changes).
 */
class AiSeoStateService
{
    ...
    /**
     * Resolve the AI SEO state for the record.
     *
     * @return array{stale: bool, hasUnpublishedChanges: bool, usedLive: bool, currentHash: string}
     */
    public function getState(DataObject $record, ?GeneratedSeo $metadata = null): array
    {
