 ...
 */
class CreateAiSeoTestDataTask extends BuildTask
{
    private const FIXTURE_RELATIVE_PATH = 'src/Fixtures/AiSeoTestData.yml';
    ...
    protected static string $description = 'Create AI SEO test pages and blocks.';
    ...
    {
        return 'Create AI SEO test data';
    }
    ...
    {
        $module = ModuleLoader::getModule('silverstripeltd/ai-seo');
        if (!$module) {
            return null;
        }

        $path = $module->getPath() . '/' . CreateAiSeoTestDataTask::FIXTURE_RELATIVE_PATH;
    ...
    private function deleteExistingRecords(): int
    {
        ...
        foreach (CreateAiSeoTestDataTask::PAGE_CLASSES as $class) {
    ...
    {
        $titlesByClass = $this->extractTitlesByClass($fixtureData, CreateAiSeoTestDataTask::PAGE_CLASSES);
